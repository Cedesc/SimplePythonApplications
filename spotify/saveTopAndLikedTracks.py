...
def createLikedTracksSave(get_playlist_items_token: str, create_playlist_token: str, add_items_to_playlist_token: str):
    ...
    # get songs of favorites
    tracks = sAPI.get_liked_songs(get_playlist_items_token)
    print(f"Get liked tracks: {tracks}")

    # the maximum value for the 'limit' is 50, but since I have more than 50 liked songs, the function has to be
    # called multiple times todo

    # convert to the ids
    ids: list[str] = sAPI.extract_ids_get_playlist_items(tracks)
